...
import com.example.communicate.databinding.DeleteLayoutBinding
import com.example.communicate.databinding.RecieveMsgBinding
import com.example.communicate.databinding.SendMsgBinding
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder.javaClass == SentMsgHolder::class.java){
            ...
            viewHolder.itemView.setOnLongClickListener{
                ...
                binding.cncel.setOnClickListener { dialog.dismiss() }
